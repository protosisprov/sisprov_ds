...
function addRowTable(v0,v1,v2,v3,v4){        
    ...
    objA.setAttribute('onclick','submitEdit('+v0+','+document.getElementById('id_nivel_2').value+')');  
    var objImg=document.createElement('img');
    
    objImg.setAttribute('src','../../../FDSoil/images/24x24/edita.png');  
    ...
    objImg.setAttribute('src','../../../FDSoil/images/24x24/delete.png');  
