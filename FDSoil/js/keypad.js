...
function Keypad() {
	...
	this.qwertyLayout = ['!@#$%^&*()_='  , 
		...
		this.SPACE     +this.SHIFT + this.HALF_SPACE + this.SPACE + this.SPACE + this.SPACE + 
		  this.HALF_SPACE + this.BACK + this.CLEAR +this.SPACE     + this.SPACE+ this.HALF_SPACE + this.CLOSE];*/
        this.qwertyAlphabetic = ['qwertyuiop', 'asdfghjklz', 'xcvbnm'];
	// Standard US keyboard layout
	this.qwertyLayout = ['|@#$%¿!¬()',
                            '7894561230',
                            'qwertyuiop',
                            'asdfghjklz',
                             this.SPACE + this.HALF_SPACE +this.HALF_SPACE+'xcvbnm',
                            this.ENTER+this.SHIFT + this.BACK + this.CLEAR +this.CLOSE];
	...
	this.regional[''] = { // Default regional settings
		...
		closeStatus: 'Accept', // Status text for close link
		...
		enterText: 'Esc', // Display text for carriage return
		//enterStatus: 'Carriage return', // Status text for carriage return
                enterStatus: 'Cancel', // Status text for carriage return
                ////cerrarText: 'Cerrar', // Display text for close link
		////cerrarStatus: 'Close the keypad', // Status text for close link
		//tabText: '→', // Display text for tab
		//tabStatus: 'Horizontal tab', // Status text for tab
		shiftText: 'Mayús', // Display text for shift link
	...
	this._defaults = { // Global defaults for all the keypad instances
		...
		//This code sets the image that opens and closes the keyboard
...
$.extend(Keypad.prototype, {
	...
	_connectKeypad: function(target, inst) {
		...
		if (!inst._inline) {
			...
			//This code removes the button that opens and closes the keyboard
