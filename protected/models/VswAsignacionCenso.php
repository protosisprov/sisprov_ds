...
class VswAsignacionCenso extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('id_asignacion_censo,persona_id, cod_estado, id_oficina, id_desarrollo', 'numerical', 'integerOnly' => true),
            ...
            array('id_asignacion_censo, persona_id, cod_estado, estado, id_oficina, nombre_oficina, id_desarrollo, nombre_desarrollo, fecha_asignacion', 'safe', 'on' => 'search'),
        );
    }
