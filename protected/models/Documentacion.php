 ...
 * @property boolean $es_multi
 * @property integer $fk_beneficiario
 *
 ...
 * @property Beneficiario $fkBeneficiario
 */
class Documentacion extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('tipo_documento_id, estatus, usuario_id_creacion, usuario_id_actualizacion, fk_beneficiario, ente_documento', 'numerical', 'integerOnly' => true),
            array('es_activo, es_multi', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id_documentacion, tipo_documento_id, documento, estatus, fecha_creacion, fecha_actualizacion, usuario_id_creacion, usuario_id_actualizacion,fk_beneficiario, es_activo, es_multi, ente_documento', 'safe', 'on' => 'search'),
        );
    }
...
//            'fkBeneficiario' => array(self::BELONGS_TO, 'Beneficiario', 'fk_beneficiario'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            ...
            'fk_beneficiario' => 'Fk Beneficiario',
            'es_activo' => 'Es Activo',
            'es_multi' => 'Es Multi',
            'ente_documento' => 'ente que envia',
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('fk_beneficiario', $this->fk_beneficiario);
        $criteria->compare('es_activo', $this->es_activo);
        $criteria->compare('es_multi', $this->es_multi);
