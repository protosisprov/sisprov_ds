 ...
 * @property string $porcentaje_vivienda
...
class Vivienda extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('tipo_vivienda_id, unidad_habitacional_id, nro_vivienda, fuente_datos_entrada_id, fecha_creacion, fecha_actualizacion, usuario_id_creacion, asignada', 'required'),
            ...
            array('construccion_mt2', 'length', 'max' => 6),
            ...
            array('porcentaje_vivienda', 'length', 'max' => 6),
            array('nro_habitaciones', 'length', 'max' => 4),
            array('coordenadas', 'length', 'max' => 200),
            array('lindero_norte, lindero_sur, lindero_este, lindero_oeste, coordenadas', 'length', 'max' => 2000),
            ...
            array('tipo_vivienda, id_vivienda, tipo_vivienda_id, unidad_habitacional_id, construccion_mt2, nro_piso, nro_vivienda, sala, comedor, lavandero, lindero_norte, lindero_sur, lindero_este, lindero_oeste, coordenadas, precio_vivienda, nro_estacionamientos, descripcion_estac, nro_habitaciones, nro_banos, fuente_datos_entrada_id, estatus_vivienda_id, cocina, fecha_creacion, fecha_actualizacion, usuario_id_creacion, usuario_id_actualizacion,asignada, porcentaje_vivienda,nro_banos_auxiliar,nro_banos_auxiliar', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            ...
            //'construccion_mt2' => 'Área de Vivienda mt2 <span  class="required">*<span>',
            'construccion_mt2' => 'Área de Vivienda mt2',
            'nro_piso' => 'Número de Piso <span  class="required">*<span>',
            ...
            'porcentaje_vivienda' => 'Porcentaje Vivienda',
            'nro_banos_auxiliar' => 'Baño Auxiliar',
            'tipo_vivienda' => 'Tipo de Unidad Multifamiliar',
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('porcentaje_vivienda', $this->porcentaje_vivienda, true);
        $criteria->compare('nro_banos_auxiliar', $this->nro_banos_auxiliar, true);
