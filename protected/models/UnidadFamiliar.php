 ...
 * @property integer $fk_tipo_documento_multi
 * @property integer $documentacion_id
 *
 * The followings are the available model relations:
 * @property GrupoFamiliar[] $grupoFamiliars
 * @property AnalisisCredito[] $analisisCreditos
 * @property Maestro $fkTipoDocumentoMulti
...
class UnidadFamiliar extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('beneficiario_id, condicion_unidad_familiar_id, procedencia_beneficio_id, fuente_datos_entrada_id, total_personas_cotizando, cantidad_dispacitados, usuario_id_creacion, usuario_id_actualizacion, estatus, fk_tipo_documento_multi', 'numerical', 'integerOnly' => true),
            ...
            array('id_unidad_familiar, nombre, beneficiario_id, condicion_unidad_familiar_id, ingreso_total_familiar, procedencia_beneficio_id, fuente_datos_entrada_id, total_personas_cotizando, cantidad_dispacitados, fecha_creacion, fecha_actualizacion, usuario_id_creacion, usuario_id_actualizacion, estatus, observacion, ingreso_total_familiar_suma_faov, fk_tipo_documento_multi, documentacion_id', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            ...
            'fkTipoDocumentoMulti' => array(self::BELONGS_TO, 'Maestro', 'fk_tipo_documento_multi'),
            'documentacion' => array(self::BELONGS_TO, 'Documentacion', 'documentacion_id'),
    ...
    public function attributeLabels() {
        return array(
            ...
            'fk_tipo_documento_multi' => 'Fk Tipo Documento Multi',
            'documentacion_id' => 'Documentacion',
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('fk_tipo_documento_multi', $this->fk_tipo_documento_multi);
        $criteria->compare('documentacion_id', $this->documentacion_id);
