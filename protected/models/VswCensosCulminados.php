...
/**
 * This is the model class for table "vsw_censos_culminados".
 *
 * The followings are the available columns in table 'vsw_censos_culminados':
 ...
 */
class VswCensosCulminados extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('id_desarrollo, cod_estado, id_unidad_habitacional, id_beneficiario_temporal, id_beneficiario, persona_id, cedula, iduser', 'numerical', 'integerOnly' => true),
            ...
            array('id_desarrollo,cod_estado, estado, nombre_desarrollo, id_unidad_habitacional, nombre_unidad_multifamiliar, id_beneficiario_temporal, id_beneficiario, persona_id, cedula, nombre_adjudicado, nro_piso, nro_vivienda, iduser, empadronador_usuario', 'safe', 'on' => 'search'),
        );
    }
     ...
     * @return VswCensosCulminados the static model class
     */
