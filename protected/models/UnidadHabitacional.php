...
class UnidadHabitacional extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('desarrollo_id, gen_tipo_inmueble_id, total_unidades, registro_publico_id, tipo_documento_id, ano, fuente_datos_entrada_id, usuario_id_creacion, usuario_id_actualizacion, estatus, num_protocolo, total_unidad_censada, id_parcela', 'numerical', 'integerOnly' => true),
            ...
            array('id_unidad_habitacional, nombre, desarrollo_id, gen_tipo_inmueble_id, total_unidades, registro_publico_id, tipo_documento_id, fecha_registro, tomo, ano, nro_documento, asiento_registral, folio_real, nro_matricula, fuente_datos_entrada_id, fecha_creacion, fecha_actualizacion, usuario_id_creacion, usuario_id_actualizacion, estatus, num_protocolo, lindero_norte, lindero_sur, lindero_este, lindero_oeste, total_unidad_censada, id_parcela, es_parcela, parcela', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            ...
            'pertenece_parcela' => 'Pertenece a una parcela',
            'es_parcela' => 'Es una Parcela',
            'id_parcela' => 'Parcela',
