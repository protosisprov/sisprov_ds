...
class Maestro extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('padre, hijo, usuario_id_creacion', 'numerical', 'integerOnly' => true),
            array('es_activo', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id_maestro, descripcion, padre, hijo, es_activo', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search() {
        ...
        $criteria->order = 'id_maestro DESC';
    ...
    public function username($id){
        ...
        //$usuario = Yii::app()->user->um->loadUserById(3,true)
