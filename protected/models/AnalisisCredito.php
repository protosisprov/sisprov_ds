...
//    public $vivienda;
    ...
    public function rules() {
        ...
        return array(
            ...
            array('monto_inicial, sub_directo_habitacional, sub_vivienda_perdida, monto_cuota_f_total, alicuota_fondo_garantia, maxima_capacidad_pago, monto_cuota_finan_requerida, max_cuota_finan_porct, diferencia_pago, cuota_extraordinarias,comision_flat,flat', 'safe'),
...
//            'tasaFongar' => array(self::BELONGS_TO, 'TasaFongar', 'tasa_fongar_id'),
    ...
    public function attributeLabels() {
        return array(
            ...
            'fecha_protocolizacion' => 'Fecha de Análisis',
