...
//        var_dump($fechaIn);exit;
    ...
    public function renderTraza($idBeneficiario) {
        ...
        switch ($traza) {
            case 1:// SEGUNDA PANTALLA DE CENSO 
                ...
                break;
            case 2: // TERCERA PANTALLA DE CENSO
                $this->redirect(array('beneficiario/createDatos', 'id' => $idBeneficiario));
                break;
            case 4: // INDICA QUE YA CULMINO EL CENSO
                        ...
                        case 1: // checa las centenas
                            if (substr($xaux, 0, 3) < 100) { // si el grupo de tres dígitos es menor a una centena ( < 99) no hace nada y pasa a revisar las decenas
                                ...
                                if (TRUE === array_key_exists($key, $xarray)) {  // busco si la centena es número redondo (100, 200, 300, 400, etc..)
                                    $xseek = $xarray[$key];
                                    $xsub = Generico::SubFijo($xaux);  // devuelve el subfijo correspondiente (Millón, Millones, Mil o nada)
...
// END FUNCTION
    ...
    //funcion que retorna el primer nombre y el segundo apellido del grupo familiar
