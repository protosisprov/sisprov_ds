...
///////////////////////////////////////////////////////////////////////////////////
        ...
        $c = 0;
        foreach($reporte as $reporteGrafico){
            if($reporteGrafico["activo"]>0 || $reporteGrafico["inactivo"]>0 || $reporteGrafico["borrado"]>0 || $reporteGrafico["validado_banavih_uni"]>0 || $reporteGrafico["validado_saren_uni"]>0 || $reporteGrafico["devuelto_saren_uni"]>0){
                $estados_grafico[] = $reporteGrafico['estado'];
                $series[$c] = array(
                                'activo' => $reporteGrafico["activo"], 
                                'inactivo' => $reporteGrafico["inactivo"],
                                'borrado' => $reporteGrafico["borrado"],
                                'validado_banavih_uni' => $reporteGrafico["validado_banavih_uni"],
                                'validado_saren_uni' => $reporteGrafico["validado_saren_uni"],
                                'devuelto_saren_uni' => $reporteGrafico["devuelto_saren_uni"],
                        );
                $c++;
            }
        }
...
///////////////////////////////////////////////////////////////////////////////////
        ...
        $this->render('reporteDocumentacionMultiPdf',array('reporte'                      => $reporte,
                                                   'activo_total'                 => $activo_total,
                                                   'inactivo_total'               => $inactivo_total,
                                                   'borrado_total'                => $borrado_total,
                                                   'validado_banavih_multi_total' => $validado_banavih_multi_total,
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function actionreporteDocumentacionUniPdf()
    {
        $estados = Tblestado::model()->findAll();
...
///////////////////////////////////////////////////////////////////////////////////
        ...
        $this->render('reporteDocumentacionUniPdf',array('reporte'                      => $reporte,
                                                   'activo_total'                 => $activo_total,
                                                   'inactivo_total'               => $inactivo_total,
                                                   'borrado_total'                => $borrado_total,
                                                   'validado_banavih_uni_total'   => $validado_banavih_uni_total,
