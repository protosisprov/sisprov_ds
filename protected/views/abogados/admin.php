        ...
        array(
            ...
            'buttons' => array(
                'ver' => array(
                    ...
                    'icon' => 'eye-open',
                    'size' => 'medium',
                    'visible' => '((Yii::app()->user->checkAccess("action_abogados_view")))',
                ...
                'modificar' => array(
                    ...
                    'size' => 'medium',
                    'visible' => '((Yii::app()->user->checkAccess("action_abogados_update")))',
...
//                    'visible' => 'Asignar($data->username);'
                ...
                'pdf' => array(
                    ...
                    'size' => 'medium',
                    'visible' => '((Yii::app()->user->checkAccess("action_abogados_pdf")))',
