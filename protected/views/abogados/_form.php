...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        echo $form->dropDownListGroup($model, 'tipo_abogado_id', array('wrapperHtmlOptions' => array('class' => 'col-sm-12 limpiar'),
            'widgetOptions' => array(
                ...
                'htmlOptions' => array('empty' => 'SELECCIONE', 'placeholder' => 'Placeholder content',),
            )
                )
        );
        ?>
    ...
    <div class="col-md-4 inpreabogado" style ="display: none">
        <!-- <b> Inpreabogado </b> <span class="required">*</span> -->
        <?php echo $form->textFieldGroup($model, 'inpreabogado', array('widgetOptions' => array('htmlOptions' => array('class' => 'span5', 'maxlength' => 7,'placeholder'=>'Inpreabogado')))); ?>
    </div>
...
<div class="row rifabogado" style ="display: none">
    ...
    <div class="col-md-4">
        <b>Nº de RIF</b> <span class="required">*</span>
        <?php echo $form->textFieldGroup($model, 'rif_abogado', array('widgetOptions' => array('htmlOptions' => array('class' => 'span5', 'maxlength' => 20,'placeholder'=>'Ejemplo: V-00000000-0')))); ?>
    </div>
    <div class="col-md-4" >
...
<div class="row rifabogado" style ="display: none" >
    <div class="col-md-4">
        ...
        <?php echo $form->textFieldGroup($model, 'folio', array('widgetOptions' => array('htmlOptions' => array('class' => 'span5', 'maxlength' => 3)))); ?>
    </div>
    <div class="col-md-4">
