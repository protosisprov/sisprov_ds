        ...
        array(
            ...
            'buttons' => array(
                'ver' => array(
                    ...
                    'icon' => 'eye-open',
                    'size' => 'medium',
                    'visible' => '((Yii::app()->user->checkAccess("action_oficina_view")))',
                ...
                'modificar' => array(
                    ...
                    'size' => 'medium',
                    'visible' => '((Yii::app()->user->checkAccess("action_oficina_update")))', 
                ...
                'pdf' => array(
                    ...
                    'size' => 'medium',
                    'visible' => '((Yii::app()->user->checkAccess("action_oficina_pdf")))', 
