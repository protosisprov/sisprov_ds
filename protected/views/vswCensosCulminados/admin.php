...
<h1>Gestion de Censo Socio-economico Culminados</h1>
...
$this->widget('booster.widgets.TbGridView', array(
    ...
    array(
        ...
        array(
            ...
            'template' => '{ver}{update}{updateFamiliar}{validarCenso}',
            'buttons' => array(
                'ver' => array(
                    'label' => 'Ver',
                    'icon' => 'eye-open',
                ...
                'updateFamiliar' => array(
                    ...
                    'url' => 'Yii::app()->createUrl("grupoFamiliar/update/", array("id"=>buscarUNidad($data->id_beneficiario)))',
                ),
                'validarCenso' => array(
                    'label' => 'Validar Censo',
                    ...
                    'size' => 'medium',
//                    'visible' => '((Yii::app()->user->checkAccess("action_grupofamiliar_update")))',
                    'url' => 'Yii::app()->createUrl("beneficiario/validarCenso/", array("id"=>$data->id_beneficiario))',
                ),
            ),
        ),
    ),
