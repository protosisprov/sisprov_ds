        ...
        array(
            ...
            'buttons' => array(
                'ver' => array(
                    ...
                    'icon' => 'eye-open',
                    'size' => 'medium',
                    'visible' => '((Yii::app()->user->checkAccess("action_unidadhabitacional_view")))',
                ...
                'pdf' => array(
                    ...
                    'size' => 'medium',
                    'visible' => '((Yii::app()->user->checkAccess("action_unidadhabitacional_pdf")))',
                ...
                'modificar' => array(
                    ...
                    'size' => 'medium',
                    'visible' => '((Yii::app()->user->checkAccess("action_unidadhabitacional_update")))',
