...
<div class="row">
    <div class='col-md-4'>
        <?php
        echo $form->textFieldGroup($model, 'nombre_completo', array('widgetOptions' => array('htmlOptions' => array('class' => 'span5', 'maxlength' => 200))));
        ?>
    </div>
...
<!--    <div class='col-md-4'>
        ...
        <?php
//         echo $form->textFieldGroup($model, 'telf_habitacion', array('widgetOptions' => array('htmlOptions' => array('class' => 'span5', 'maximumInputLength' => 11, 'minimumInputLength' => 11,))));
...
<!--    <div class='col-md-4'>
        <?php
//         echo $form->textFieldGroup($model, 'telf_celular', array('widgetOptions' => array('htmlOptions' => array('class' => 'span5', 'maximumInputLength' => 11, 'minimumInputLength' => 11,))));

        ?>
        <?php // echo $form->labelEx($model, 'telf_celular'); ?><br>
        <?php
//        $this->widget(
//                'booster.widgets.TbSelect2', array(
//            'asDropDownList' => false,
...
//        );
        ?>
        <?php
//        echo $form->textFieldGroup($model, 'correo_electronico', array('widgetOptions' => array('htmlOptions' => array('class' => 'span5', 'maxlength' => 150))));
        ?>
    </div>
</div>
