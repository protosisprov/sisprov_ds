...
<h1>Modificar Nombre de Adjudicado</h1>
<br><br>
...
<div class="row">
    <div class="col-md-12">
        ...
        $this->widget(
            ...
            'content' => $this->renderPartial('_form_update', array('form' => $form, 'model' => $model), TRUE),
    ...
    <div class="well">
        <div class="pull-center" style="text-align: right;">
            ...
            $this->widget('booster.widgets.TbButton', array(
                ...
                'icon' => 'ban-circle',
                'htmlOptions' => array(
                    'onclick' => 'document.location.href ="' . $this->createUrl('modificarNombre') . '";'
                )
            ));
            ?>
        </div>
