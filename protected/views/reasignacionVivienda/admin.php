...
$this->widget(
    ...
    'columns' => array(
        ...
        array(
            ...
            'header' => 'Cédula',
            'value' => '$data->beneficiarioIdAnterior->fkNacionalidad->descripcion." - ".$data->beneficiarioIdAnterior->cedula',
        ),
        array(
            'name' => 'beneficiario_id_anterior',
          ...
          array(
            ...
            'header' => 'Cédula',
            'value' => '$data->beneficiarioIdActual->fkNacionalidad->descripcion." - ".$data->beneficiarioIdActual->cedula',
        ),
        array(
            'name' => 'beneficiario_id_actual',
        ...
        array(
            ...
            'buttons' => array(
                'ver' => array(
                    ...
                    'icon' => 'eye-open',
                    'size' => 'medium',
                    'visible' => '((Yii::app()->user->checkAccess("action_reasignacionvivienda_view")))',
