...
//                ),
                ...
                'continuar' => array(
                    ...
                    'icon' => 'play',
                    'size' => 'medium',
                    'visible' =>  '((Yii::app()->user->checkAccess("action_beneficiario_culminarregistro")) && traza($data->id_beneficiario)!=100)', //REVISAR-> VALIDAR SI SE CUMPLE CON LAS 2 CONDICIONES
